...
model_urls = {
    'resnet50': 'https://www.dropbox.com/sh/5k4t77mt4011gyr/AAD_tJBuIWFpq4EUAtvc4E5ha/CMC_resnet50v3.pth?dl=0'
}
...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        #cached_file = './models/CMC_resnet50v3.pth'
        #f = torch.load(cached_file)
...
class MyResNetsCMC(nn.Module):
    def __init__(self, name='resnet50v3'):
...
def load_pretrained_cmc():
    model = MyResNetsCMC()

    import os
    model_path = os.path.join(os.path.dirname(__file__), 'cached_models/CMC_resnet50v3.pth')
